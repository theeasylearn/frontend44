...
//reusable functional component Item
function Item(props)
{
    return ( <div className="col-lg-4 col-sm-6 mb-4">
        ...
        <div className="portfolio-item">
          ...
          <div className="portfolio-caption">
            ...
            <div className="portfolio-caption-subheading text-muted">{props.description}</div>
          </div>
        </div>
      </div>);
}
function Portfolios()
{
    return (   <section className="page-section bg-light" id="portfolio">
        <div className="container">
          ...
          <div className="row">
            <Item title='Digital Watch' description='with Heart attack warning' photo='assets/img/portfolio/1.jpg' />
           
            <Item title='shoes' description='to fly in the sky' photo='assets/img/portfolio/2.jpg' />

            <Item title='Medical Kit' description='to be foreever young' photo='assets/img/portfolio/3.jpg' />

            <Item title='coca cola' description='never be thirsty again' photo='assets/img/portfolio/4.jpg' />

            <Item title='laptop' description='for fun ' photo='assets/img/portfolio/5.jpg' />

            <Item title='Mr India bend' description='to disappear' photo='assets/img/portfolio/6.jpg' />
...
// resuable function components
function Member(props)
{
  // props is object that has all property named password in Member tag 
    return ( <div className="col-lg-4">
      <div className="team-member">
        <img className="mx-auto rounded-circle" src={props.photo} alt="..." />
        <h4>{props.name}</h4>
...
function TeamMembers()
{
    return ( <section className="page-section bg-light" id="team">
        <div className="container">
          ...
          <div className="row">
              <Member name='Raj Kumar' position='Lead Developer' photo='assets/img/team/1.jpg' />
              <Member name='Mona Singh' position='mobile app developer' photo='assets/img/team/2.jpg' />
              <Member name='Nihar Patel' position='UI/UX Designer' photo='assets/img/team/3.jpg' />
